    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          (0, _alerts.showAlert)('error', 'Error: ' + _t.response.data.message);
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
...
var displayMap = exports.displayMap = function displayMap(locations) {
  if (mapElement) {
    var _locations = JSON.parse(mapElement.dataset.locations);
    mapboxgl.accessToken = mapElement.dataset.mapboxToken;
    var geojson = {
      type: 'FeatureCollection',
      features: _locations.map(function (location) {
        return {
          type: 'Feature',
          geometry: {
            type: 'Point',
    ...
    geojson.features.forEach(function (marker) {
      ...
      new mapboxgl.Popup({
        offset: 30,
        closeOnClick: false
      }).setLngLat(marker.geometry.coordinates).setHTML("<p>Day ".concat(marker.properties.day, ": ").concat(marker.properties.description, "</p>")).addTo(map);
      ...
      map.addLayer({
        ...
        source: {
          ...
          data: {
            ...
            geometry: {
              type: 'LineString',
              coordinates: _locations.map(function (location) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Account ".concat(type.toUpperCase(), " updated."));
            window.setTimeout(function () {
